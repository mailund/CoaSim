...
if (number_cases_with_mutation + number_controls_with_mutation) > len(cases):
    print "Too few cases (len(cases) = ",len(cases)," number_cases_with_mutation = ",number_cases_with_mutation," number_controls_with_mutation = ",number_controls_with_mutation
    exit
