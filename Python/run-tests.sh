...
tests='markersTest.py randomMarkersTest.py simulateTest.py intervalsTest.py treesTest.py nodesTest.py customMarkerTest.py callbackTest.py iteratorTest.py'
