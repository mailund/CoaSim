    ...
    public:
        ...
        private:
            ...
            public:
                ...
                recomb_node_pair_t;
                recomb_node_pair_t recombination(double time, Node *child, double cross_over_point);
                
                typedef std::pair<GeneConversionNode*,GeneConversionNode*> gene_conv_node_pair_t;
